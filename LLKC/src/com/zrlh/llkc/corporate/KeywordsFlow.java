...
public class KeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    private String[] color = {"#d57df1", "#aa0902", "#f4524b", "#4da129", "#1e2bd6",
    		"#3da4eb", "#e04e00", "#6f88f1"};
...
//                int ranColor = 0xff000000 | random.nextInt(0x0077ffff); 
                String ranColor = color[random.nextInt(color.length)];
                // 随机位置，糙值  
                ...
                txt.setText(keyword);  
                txt.setTextColor(Color.parseColor(ranColor));  
